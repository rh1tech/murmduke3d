...
/* pvWall_t - Potentially Visible Wall structure for rendering
 * Moved here from engine.c for PSRAM allocation support */
...
/* RP2350: Large arrays are allocated in PSRAM at runtime.
 * These are extern pointers defined in psram_data.c */
#ifdef RP2350_PSRAM
...
#ifdef RP2350_PSRAM
extern int32_t *validmodexdim, *validmodeydim;
#else
...
#ifdef RP2350_PSRAM
extern short *startumost, *startdmost;
#else
...
#ifdef RP2350_PSRAM
extern short *headspritesect, *headspritestat;
extern short *prevspritesect, *prevspritestat;
extern short *nextspritesect, *nextspritestat;
#else
...
EXTERN EXT_RAM_ATTR short nextspritesect[MAXSPRITES], nextspritestat[MAXSPRITES];
     ...
     */
#ifdef RP2350_PSRAM
extern uint8_t *show2dsector;
extern uint8_t *show2dwall;
extern uint8_t *show2dsprite;
#else
