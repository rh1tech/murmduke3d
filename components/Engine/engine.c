...
#ifdef RP2350_PSRAM
/* Allocated in PSRAM via psram_data_init() */
extern int32_t *slopalookup;
#else
...
#ifdef RP2350_PSRAM
/* Allocated in PSRAM via psram_data_init() */
extern short *radarang, *radarang2;
extern uint16_t *sqrtable, *shlookup;
#else
...
/* vector_t, coo2D_t and pvWall_t are now defined in build.h for PSRAM support */

// Potentially Visible walls are stored in this stack.
#ifdef RP2350_PSRAM
/* Allocated in PSRAM via psram_data_init() */
extern pvWall_t *pvWalls;
#else
...
#ifdef RP2350_PSRAM
/* Allocated in PSRAM via psram_data_init() */
extern short *bunchWallsList;
extern short *bunchfirst, *bunchlast;
#else
...
extern uint8_t *smostwalltype;
extern int32_t *smostwall;
#else
...
extern int32_t *spritesx;
extern int32_t *spritesy;
extern spritetype **tspriteptr;
extern int32_t *spritesz;
#else
...
#ifdef RP2350_PSRAM
/* Allocated in PSRAM via psram_data_init() */
extern int16_t *uwall, *dwall;
extern int32_t *swplc, *lplc;
extern int32_t *swall, *lwall;
#else
