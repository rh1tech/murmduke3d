...
#ifdef RP2350_PSRAM
/* hittype allocated in PSRAM via psram_data_init() */
#else
...
#ifdef RP2350_PSRAM
/* ps allocated in PSRAM via psram_data_init() */
#else
...
#ifdef RP2350_PSRAM
/* script allocated in PSRAM via psram_data_init() */
#else
EXT_RAM_ATTR int32_t script[MAXSCRIPTSIZE];
#endif
int32_t *scriptptr,*insptr,*labelcode,labelcnt;
#ifdef RP2350_PSRAM
/* actorscrptr allocated in PSRAM via psram_data_init() */
#else
...
#ifdef RP2350_PSRAM
/* myxbak, myybak, myzbak allocated in PSRAM via psram_data_init() */
#else
...
#ifdef RP2350_PSRAM
/* oldipos, bakipos, curipos allocated in PSRAM via psram_data_init() */
#else
